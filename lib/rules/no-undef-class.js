    ...
    schema: [
      {
        ...
        properties: {
          ...
          markAsDef: { type: "array" },
        },
      }
    ],
  },
  create(context: Object) {
    const markAsDef = _.get(context, "options[0].markAsDef");
    ...
    return {
      ...
      MemberExpression: (node: JsNode) => {
        ...
        if (classesMap && classesMap[propertyName] == null &&
          exportPropsMap && exportPropsMap[propertyName] == null && markAsDef && markAsDef.indexOf(propertyName) === -1) {
